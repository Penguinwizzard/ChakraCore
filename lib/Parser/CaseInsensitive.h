...
namespace UnifiedRegex
{
    namespace CaseInsensitive
    {
        ...
        // Following two functions return equivs from UnicodeData (for wchar_t) and CaseFolding
        ...
        // Returns equivs only from the given source. Some case-folding mappings already exist in
