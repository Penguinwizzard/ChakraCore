...
enum FncFlags
{
    ...
    kFunctionIsClassConstructor                 = 1 << 18,
    kFunctionIsClassMember                      = 1 << 19,
    kFunctionNameIsHidden                       = 1 << 20, // True if a named function expression has its name hidden from nested functions
    kFunctionIsGeneratedDefault                 = 1 << 21, // Is the function generated by us as a default (e.g. default class constructor)
    kFunctionHasDefaultArguments                = 1 << 22, // Function has one or more ES6 default arguments
    kFunctionIsStaticMember                     = 1 << 23,
