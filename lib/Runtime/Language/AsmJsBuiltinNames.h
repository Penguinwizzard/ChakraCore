...
ASMJS_SIMD_NAMES(int32x4_withX,                             withX)
ASMJS_SIMD_NAMES(int32x4_withY,                             withY)
ASMJS_SIMD_NAMES(int32x4_withZ,                             withZ)
ASMJS_SIMD_NAMES(int32x4_withW,                             withW)
...
ASMJS_SIMD_NAMES(float32x4_withX,                           withX)
ASMJS_SIMD_NAMES(float32x4_withY,                           withY)
ASMJS_SIMD_NAMES(float32x4_withZ,                           withZ)
ASMJS_SIMD_NAMES(float32x4_withW,                           withW)
...
ASMJS_SIMD_NAMES(float64x2_withX,                           withX)
ASMJS_SIMD_NAMES(float64x2_withY,                           withY)
