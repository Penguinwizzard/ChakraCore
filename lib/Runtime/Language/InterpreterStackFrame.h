...
namespace Js
{
    ...
    public:
        ...
        static bool IsBrLong(OpCode op, const byte * ip)
        {
            ...
            CompileAssert(OpCodeUtil::EncodedSize(OpCode::BrLong, SmallLayout) == 2);
    ...
    private:
        ...
        Js::OpCode ReadWordJsOpCode(const byte *& ip);
        Js::OpCodeAsmJs ReadJsOpCodeAsmJs(const byte *& ip);
        Js::OpCodeAsmJs ReadWordJsOpCodeAsmJs(const byte *& ip);
