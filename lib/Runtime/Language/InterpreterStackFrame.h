...
namespace Js
{
    ...
    private:
        ...
        void OP_InitForInEnumerator(Var object, uint forInLoopId);
        void OP_InitForInEnumeratorWithCache(Var object, uint forInLoopId, ProfileId profileId);
        ForInObjectEnumerator * GetForInEnumerator(uint forInLoopId);
