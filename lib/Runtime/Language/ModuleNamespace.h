...
namespace Js
{
    ...
    public:
        ...
        virtual BOOL DeleteProperty(PropertyId propertyId, PropertyOperationFlags flags) override { return FALSE; }
        ...
        virtual BOOL SetItem(uint32 index, Var value, PropertyOperationFlags flags) override { Assert(false); return false; }
        virtual BOOL DeleteItem(uint32 index, PropertyOperationFlags flags) override { Assert(false); return false; }
