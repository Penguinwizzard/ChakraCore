...
#endif
#ifndef DEF3_WMS_R2
#define DEF3_WMS_R2(process, op, func, y, t0, t1) DEF3_WMS(process, op, func, y)
#endif
#ifndef DEF3_WMS_R3
#define DEF3_WMS_R3(process, op, func, y, t0, t1, t2) DEF3_WMS(process, op, func, y)
#endif
...
// External Calls
  ...
  DEF3_WMS_R2( CUSTOM     , ArgOut_Db         , OP_ArgOut_Db            , Reg1Double1,   Js::Var, double)
  DEF3_WMS_R2( CUSTOM     , ArgOut_Int        , OP_ArgOut_Int           , Reg1Int1    ,  Js::Var, int32)
  DEF3_WMS_R2( CUSTOM     , Conv_VTD          , OP_Conv_VTD             , Double1Reg1  , double, Js::Var)
  DEF3_WMS_R2( CUSTOM     , Conv_VTF          , OP_Conv_VTF             , Float1Reg1   , float, Js::Var)
  DEF3_WMS_R2( CUSTOM     , Conv_VTI          , OP_Conv_VTI             , Int1Reg1      , int32, Js::Var)
// Internal Calls
  DEF3    ( CUSTOM     , I_StartCall       , OP_I_StartCall          , StartCall     )
  DEF3_WMS( CUSTOM     , I_Call            , OP_I_Call               , AsmCall       )
  DEF3_WMS_R2( CUSTOM     , I_ArgOut_Db       , OP_I_ArgOut_Db          , Reg1Double1  , Js::Var, double)
  DEF3_WMS_R2( CUSTOM     , I_ArgOut_Flt      , OP_I_ArgOut_Flt         , Reg1Float1    ,Js::Var, float)
  DEF3_WMS_R2( CUSTOM     , I_ArgOut_Int      , OP_I_ArgOut_Int         , Reg1Int1      ,Js::Var, int32)
  DEF3_WMS_R2( CUSTOM     , I_Conv_VTD        , OP_I_Conv_VTD           , Double2       ,double, double)
  DEF3_WMS_R2( CUSTOM     , I_Conv_VTI        , OP_I_Conv_VTI           , Int2          ,int32, int32)
  DEF3_WMS_R2( CUSTOM     , I_Conv_VTF        , OP_I_Conv_VTF           , Float2        ,float, float)
...
// Switching
  DEF3_WMS_R2( INT2       , BeginSwitch_Int   , Ld_Int                  , Int2          )
  ...
  DEF3_WMS_R2( CUSTOM     , Conv_DTI          , Op_Db_To_Int            , Int1Double1   )
  DEF3_WMS_R2( CUSTOM     , Conv_ITD          , Op_Int_To_Db            , Double1Int1   )
  DEF3_WMS_R2( CUSTOM     , Conv_UTD          , Op_UInt_To_Db           , Double1Int1   )
  DEF3_WMS_R2( CUSTOM     , Conv_FTD          , Op_Float_To_Db          , Double1Float1, double, float)
  DEF3_WMS_R2( CUSTOM     , Conv_FTI          , Op_Float_To_Int         , Int1Float1, int32, float)
  ...
  DEF3_WMS_R2( INT2       , Ld_Int            , Ld_Int                  , Int2          , int32, int32)
  DEF3_WMS_R2( INT2       , Neg_Int           , Neg_Int                 , Int2, int32, int32)
  DEF3_WMS_R2( INT2       , Not_Int           , Not_Int                 , Int2, int32, int32)
  DEF3_WMS_R2( INT2       , LogNot_Int        , LogNot_Int              , Int2, int32, int32)
  DEF3_WMS_R2( INT2       , Conv_ITB          , Int_To_Bool             , Int2, int32, int32)
  DEF3_WMS_R3( INT3       , Add_Int           , Add_Int                 , Int3, int32, int32, int32)
  DEF3_WMS_R3( INT3       , Sub_Int           , Sub_Int                 , Int3, int32, int32, int32)
  DEF3_WMS_R3( INT3       , Mul_Int           , Mul_Int                 , Int3, int32, int32, int32)
  DEF3_WMS_R3( INT3       , Div_Int           , Div_Int                 , Int3, int32, int32, int32)
  DEF3_WMS_R3( INT3       , Rem_Int           , Rem_Int                 , Int3, int32, int32, int32)
  DEF3_WMS_R3( INT3       , And_Int           , And_Int                 , Int3, int32, int32, int32)
  DEF3_WMS_R3( INT3       , Or_Int            , Or_Int                  , Int3, int32, int32, int32)
  DEF3_WMS_R3( INT3       , Xor_Int           , Xor_Int                 , Int3, int32, int32, int32)
  DEF3_WMS_R3( INT3       , Shl_Int           , Shl_Int                 , Int3, int32, int32, int32)
  DEF3_WMS_R3( INT3       , Shr_Int           , Shr_Int                 , Int3, int32, int32, int32)
  DEF3_WMS_R3( INT3       , Shr_UInt          , Shr_UInt                , Int3, int32, int32, int32)

  DEF3_WMS_R3( INT3       , Mul_UInt          , Mul_UInt                , Int3, int32, int32, int32)
  DEF3_WMS_R3( INT3       , Div_UInt          , Div_UInt                , Int3, int32, int32, int32)
  DEF3_WMS_R3( INT3       , Rem_UInt          , Rem_UInt                , Int3, int32, int32, int32)

  DEF3_WMS_R2( DOUBLE2    , Ld_Db             , Ld_Db                   , Double2       , double, double)
  DEF3_WMS_R2( FLOAT2     , Ld_Flt            , Ld_Flt                  , Float2, float, float)
  DEF3_WMS_R2( DOUBLE2    , Neg_Db            , Neg_Db                  , Double2, double, double)
  DEF3_WMS_R3( DOUBLE3    , Add_Db            , Add_Db                  , Double3       , double, double, double)
  DEF3_WMS_R3( DOUBLE3    , Sub_Db            , Sub_Db                  , Double3, double, double, double)
  DEF3_WMS_R3( DOUBLE3    , Mul_Db            , Mul_Db                  , Double3, double, double, double)
  DEF3_WMS_R3( DOUBLE3    , Div_Db            , Div_Db                  , Double3, double, double, double)
  DEF3_WMS_R3( DOUBLE3    , Rem_Db            , Rem_Db                  , Double3, double, double, double)

  //float math
  DEF3_WMS_R2( FLOAT2     , Neg_Flt           , Neg_Flt                 , Float2, float, float)
  DEF3_WMS_R3( FLOAT3     , Add_Flt           , Add_Flt                 , Float3        , float, float, float)
  DEF3_WMS_R3( FLOAT3     , Sub_Flt           , Sub_Flt                 , Float3, float, float, float)
  DEF3_WMS_R3( FLOAT3     , Mul_Flt           , Mul_Flt                 , Float3, float, float, float)
  DEF3_WMS (FLOAT3     , Div_Flt           , Div_Flt                 , Float3, float, float, float)

  DEF3_WMS_R3( INT3       , CmLt_Int          , Lt_Int                  , Int3          , int32, int32, int32)
  DEF3_WMS_R3( INT3       , CmLe_Int          , Le_Int                  , Int3, int32, int32, int32)
  DEF3_WMS_R3( INT3       , CmGt_Int          , Gt_Int                  , Int3, int32, int32, int32)
  DEF3_WMS_R3( INT3       , CmGe_Int          , Ge_Int                  , Int3, int32, int32, int32)
  DEF3_WMS_R3( INT3       , CmEq_Int          , Eq_Int                  , Int3, int32, int32, int32)
  DEF3_WMS_R3( INT3       , CmNe_Int          , Ne_Int                  , Int3, int32, int32, int32)

  DEF3_WMS_R3( INT3       , CmLt_UInt        , Lt_UInt                 , Int3, int32, int32, int32)
  DEF3_WMS_R3( INT3       , CmLe_UInt        , Le_UInt                 , Int3, int32, int32, int32)
  DEF3_WMS_R3( INT3       , CmGt_UInt        , Gt_UInt                 , Int3, int32, int32, int32)
  DEF3_WMS_R3( INT3       , CmGe_UInt        , Ge_UInt                 , Int3, int32, int32, int32)

  DEF3_WMS_R3( INT1DOUBLE2, CmLt_Db           , CmpLt_Db                , Int1Double2, int32, double, double)
  DEF3_WMS_R3( INT1DOUBLE2, CmLe_Db           , CmpLe_Db                , Int1Double2   int32, double, double)
  DEF3_WMS_R3( INT1DOUBLE2, CmGt_Db           , CmpGt_Db                , Int1Double2   int32, double, double)
  DEF3_WMS_R3( INT1DOUBLE2, CmGe_Db           , CmpGe_Db                , Int1Double2   int32, double, double)
  DEF3_WMS_R3( INT1DOUBLE2, CmEq_Db           , CmpEq_Db                , Int1Double2   int32, double, double)
  DEF3_WMS_R3( INT1DOUBLE2, CmNe_Db           , CmpNe_Db                , Int1Double2   int32, double, double)

  DEF3_WMS_R3( INT1FLOAT2 , CmLt_Flt          , CmpLt_Flt               , Int1Float2    , int32, float, float)
  DEF3_WMS_R3( INT1FLOAT2 , CmLe_Flt          , CmpLe_Flt               , Int1Float2, int32, float, float)
  DEF3_WMS_R3( INT1FLOAT2 , CmGt_Flt          , CmpGt_Flt               , Int1Float2, int32, float, float)
  DEF3_WMS_R3( INT1FLOAT2 , CmGe_Flt          , CmpGe_Flt               , Int1Float2, int32, float, float)
  DEF3_WMS_R3( INT1FLOAT2 , CmEq_Flt          , CmpEq_Flt               , Int1Float2, int32, float, float)
  DEF3_WMS_R3( INT1FLOAT2 , CmNe_Flt          , CmpNe_Flt               , Int1Float2, int32, float, float)

  DEF3_WMS_R2( INT2       , Abs_Int           , Abs_Int                 , Int2          , int32, int32)
  DEF3_WMS_R3( INT3       , Min_Int           , Min_Int                 , Int3, int32, int32, int32)
  DEF3_WMS_R3( INT3       , Max_Int           , Max_Int                 , Int3, int32, int32, int32)
  DEF3_WMS_R3( INT3       , Imul_Int          , Mul_Int                 , Int3, int32, int32, int32)
  DEF3_WMS_R2( INT2       , Clz32_Int         , Clz32_Int               , Int2, int32, int32)

  DEF3_WMS_R2( CALLDOUBLE2, Sin_Db            , Math::Sin               , false, double, double)
  DEF3_WMS_R2( CALLDOUBLE2, Cos_Db            , Math::Cos               , false, double, double)
  DEF3_WMS_R2( CALLDOUBLE2, Tan_Db            , Math::Tan               , false, double, double)
  DEF3_WMS_R2( CALLDOUBLE2, Asin_Db           , Math::Asin              , false, double, double)
  DEF3_WMS_R2( CALLDOUBLE2, Acos_Db           , Math::Acos              , false, double, double)
  DEF3_WMS_R2( CALLDOUBLE2, Atan_Db           , Math::Atan              , false, double, double)
  DEF3_WMS_R2( CALLDOUBLE2, Ceil_Db           , ::ceil                  , true, double, double)
  DEF3_WMS_R2( CALLFLOAT2 , Ceil_Flt          , ::ceilf                 , _CRT_HAS_CDECL, float, float)
  DEF3_WMS_R2( CALLDOUBLE2, Floor_Db          , ::floor                 , true, double, double)
  DEF3_WMS_R2( CALLFLOAT2 , Floor_Flt         , ::floorf                , _CRT_HAS_CDECL, float, float)
  DEF3_WMS_R2( CALLDOUBLE2, Exp_Db            , Math::Exp               , false, double, double)
  DEF3_WMS_R2( CALLDOUBLE2, Log_Db            , Math::Log               , false, double, double)
  DEF3_WMS_R3( CALLDOUBLE3, Pow_Db            , Math::Pow               , false, double, double, double)
  DEF3_WMS_R2( CALLDOUBLE2, Sqrt_Db           , ::sqrt                  , true, double, double)
  DEF3_WMS_R2( CALLFLOAT2,  Sqrt_Flt          , ::sqrtf                 , _CRT_HAS_CDECL, float, float)
  DEF3_WMS_R2( CALLDOUBLE2, Abs_Db            , Math::Abs               , false         , double, double)
  DEF3_WMS_R2( CALLFLOAT2 , Abs_Flt           , ::fabsf                 , _CRT_HAS_CDECL, float, float)
  DEF3_WMS_R3( CALLDOUBLE3, Atan2_Db          , Math::Atan2             , false, double, double, double)
  DEF3_WMS_R3( CALLDOUBLE3, Min_Db            , AsmJsMath::Min<double>  , false, double, double, double)
  DEF3_WMS_R3( CALLDOUBLE3, Max_Db            , AsmJsMath::Max<double>  , false, double, double, double)

  DEF3_WMS_R2( CUSTOM     , Fround_Flt        , OP_SetFroundFlt         , Float2        , float, float)
  DEF3_WMS_R2( CUSTOM     , Fround_Db         , OP_SetFroundDb          , Float1Double1 , float, double)
  DEF3_WMS_R2( CUSTOM     , Fround_Int        , OP_SetFroundInt         , Float1Int1, float, int32)
  ...
  DEF3_WMS( CUSTOM                              , Simd128_Lt_F4                 , OP_Simd128_LtF4                   , Bool32x4_1Float32x4_2  )
  DEF3_WMS( CUSTOM                              , Simd128_Lt_I4                 , OP_Simd128_LtI4                   , Bool32x4_1Int32x4_2    )
  //DEF3_WMS( CUSTOM                              , Simd128_Lt_D2                 , OP_Simd128_LtD2                   , Float64x2_3            )

  DEF3_WMS( CUSTOM                              , Simd128_Gt_F4                 , OP_Simd128_GtF4                   , Bool32x4_1Float32x4_2  )
  DEF3_WMS( CUSTOM                              , Simd128_Gt_I4                 , OP_Simd128_GtI4                   , Bool32x4_1Int32x4_2    )
  //DEF3_WMS( CUSTOM                              , Simd128_Gt_D2                 , OP_Simd128_GtD2                   , Float64x2_3            )

  DEF3_WMS( CUSTOM                              , Simd128_LtEq_F4               , OP_Simd128_LtEqF4                 , Bool32x4_1Float32x4_2  )
  //DEF3_WMS( CUSTOM                              , Simd128_LtEq_D2               , OP_Simd128_LtEqD2                 , Float64x2_3            )

  DEF3_WMS( CUSTOM                              , Simd128_GtEq_F4               , OP_Simd128_GtEqF4                 , Bool32x4_1Float32x4_2  )
  //DEF3_WMS( CUSTOM                              , Simd128_GtEq_D2               , OP_Simd128_GtEqD2                 , Float64x2_3            )

  DEF3_WMS( CUSTOM                              , Simd128_Eq_F4                 , OP_Simd128_EqF4                   , Bool32x4_1Float32x4_2  )
  DEF3_WMS( CUSTOM                              , Simd128_Eq_I4                 , OP_Simd128_EqI4                   , Bool32x4_1Int32x4_2    )
