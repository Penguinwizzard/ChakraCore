...
EXDEF2_WMS(XXtoA1NonVar,            LdStackArgPtr,              OP_LdStackArgPtr)
  DEF2_WMS(A1toEnvMemNonVar,        LdHandlerScope,             JavascriptOperators::OP_LdHandlerScope)
...
EXDEF2_WMS(GET_ELEM_SLOT_FB,        NewInnerScGenFunc,          JavascriptGeneratorFunction::OP_NewScGenFunc)
  ...
  DEF2_WMS(A2toA1MemNonVar,         LdInnerFrameDisplay,        OP_LdFrameDisplay)
  DEF3_WMS(A1toXXMemNonVar,         LdFrameDisplayNoParent,     OP_LdFrameDisplayNoParentSetLocal, FrameDisplay *)
  DEF2_WMS(A1toA1MemNonVar,         LdInnerFrameDisplayNoParent,OP_LdFrameDisplayNoParent<true>)
  ...
  DEF3_WMS(CUSTOM_L_Value,          ScopedLdFld,                OP_GetPropertyScoped, ElementScopedP)
EXDEF3_WMS(CUSTOM_L_Value,          ScopedLdFldForTypeOf,       OP_GetPropertyForTypeOfScoped, ElementScopedP)
  DEF3_WMS(CUSTOM_L_Value,          ScopedLdMethodFld,          OP_GetMethodPropertyScoped, ElementCP)
  DEF3_WMS(CUSTOM,                  ScopedStFld,                OP_SetPropertyScoped, ElementScopedP)
EXDEF3_WMS(CUSTOM,                  ConsoleScopedStFld,         OP_ConsoleSetPropertyScoped, ElementScopedP)
  DEF3_WMS(CUSTOM,                  ScopedStFldStrict,          OP_SetPropertyScopedStrict, ElementScopedP)
...
EXDEF3    (CUSTOM_L_R0,             InitLetCachedScope,         OP_InitLetCachedScope, Reg2Aux)
  DEF3    (CUSTOM,                  InitCachedFuncs,            OP_InitCachedFuncs, Auxiliary)
...
//  DEF2    (I2toA1NonVar_FuncBody,   NewScopeSlotsWithoutPropIds,JavascriptOperators::OP_NewScopeSlotsWithoutPropIds)
