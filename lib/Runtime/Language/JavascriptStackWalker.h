...
namespace Js
{
    ...
    public:
        ...
        void Set(void *codeAddress, void *framePointer, size_t stackCheckCodeHeight, InternalFrameType frameType, InternalFrameType loopBodyFrameType,
            JavascriptFunction* function, bool inlinedFramesOnStack, bool previousInterpreterFrameIsFromBailout);
    };
#endif
    ...
    public:
        ...
        void SetCachedInternalFrameInfo(InternalFrameType frameType, InternalFrameType loopBodyFrameType, JavascriptFunction* function, bool inlinedFramesOnStack, bool prevIntFrameIsFromBailout);
