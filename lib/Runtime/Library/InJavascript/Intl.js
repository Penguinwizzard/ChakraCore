...
(function (EngineInterface) {
    ...
    //A helper function that is meant to rethrow SOE and OOM exceptions allowing them to propogate.
        ...
        function InitializeCollator(collator, localeList, options) {
            ...
            if (resolvedLocaleInfo.subTags) {
                callInstanceFunc(ArrayInstanceForEach, resolvedLocaleInfo.subTags, function (subTag) {
                    ...
                    } else if (key === "co" && value !== undefined && value !== "default" && value !== "search" && value !== "sort" && value !== "standard") {//Ignore these collation values as they shouldn't have any impact
                        collation = value;
                    }
                });
            }
    ...
    var DateTimeFormat = (function () {
        ...
        function InitializeDateTimeFormat(dateTimeFormat, localeList, options) {
             ...
             * If we speicfy {hour.integer(2)}:{minute.integer(2)} pattern string; we will always format as HH:mm.
