...
namespace Js
{
    ...
    __inline int32 TaggedInt::ToInt32(Var aValue)
    {
        ...
        return ::Math::PointerCastToIntegral<int32>(aValue);
    }
    ...
    __inline uint32 TaggedInt::ToUInt32(Var aValue)
    {
        ...
        return ::Math::PointerCastToIntegral<uint32>(aValue);
    }
    ...
    __inline int64 TaggedInt::ToInt64(Var aValue)
    {
        ...
        int64 nValue = (int64)(::Math::PointerCastToIntegral<int32>(aValue));
    ...
    __inline uint16 TaggedInt::ToUInt16(Var aValue)
    {
        ...
        return ::Math::PointerCastToIntegral<uint16>(aValue);
    }

    __inline double TaggedInt::ToDouble(Var aValue)
    {
        return (double)::Math::PointerCastToIntegral<int32>(aValue);
    }
