...
#undef  _refactor_
        ...
        static void ValidateSyntax(ScriptContext* scriptContext, const char16 *source, int sourceLength, bool isGenerator, bool isAsync, void (Parser<Js::ScriptContext>::*validateSyntax)());
