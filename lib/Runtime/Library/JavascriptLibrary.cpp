...
#undef LIBRARY_FUNCTION
    ...
    void JavascriptLibrary::InitializeRegexPrototype(DynamicObject* regexPrototype, DeferredTypeHandlerBase * typeHandler, DeferredInitializeMode mode)
    {
        ...
        Assert(regexPrototype->GetSlot(library->regexConstructorSlotIndex, ObjectSlotType::GetVar()) == library->regexConstructor);
        ...
        Assert(regexPrototype->GetSlot(library->regexExecSlotIndex, ObjectSlotType::GetVar()) == library->regexExecFunction);
        ...
        if (scriptConfig->IsES6RegExPrototypePropertiesEnabled())
        {
            ...
            Assert(regexPrototype->GetSlot(library->regexGlobalGetterSlotIndex, ObjectSlotType::GetVar()) == library->regexGlobalGetterFunction);
            ...
            Assert(regexPrototype->GetSlot(library->regexFlagsGetterSlotIndex, ObjectSlotType::GetVar()) == library->regexFlagsGetterFunction);
            ...
            if (scriptConfig->IsES6RegExStickyEnabled())
            {
                ...
                Assert(regexPrototype->GetSlot(library->regexStickyGetterSlotIndex, ObjectSlotType::GetVar()) == library->regexStickyGetterFunction);
            }
            ...
            if (scriptConfig->IsES6UnicodeExtensionsEnabled())
            {
                ...
                Assert(regexPrototype->GetSlot(library->regexUnicodeGetterSlotIndex, ObjectSlotType::GetVar()) == library->regexUnicodeGetterFunction);
            }
        }
