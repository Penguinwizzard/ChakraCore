...
namespace Js
{
    ...
    {
        return this->IncreaseCountField(CounterFields::DebuggerScopeIndex);
    }
    void 
    FunctionBody::SetDebuggerScopeIndex(uint32 index)
    {
        this->SetCountField(CounterFields::DebuggerScopeIndex, index);
    }
...
#pragma prefast(suppress:6386, "The analysis assume didn't help prefast figure out this is in range")
    ...
    {
        Assert(this->dynamicProfileInfo != nullptr);
        return this->GetCountField(CounterFields::SavedPolymorphicCacheState);
    }
    void FunctionBody::SetSavedPolymorphicCacheState(uint32 state)
    {
        this->SetCountField(CounterFields::SavedPolymorphicCacheState, state);
    }
#endif
