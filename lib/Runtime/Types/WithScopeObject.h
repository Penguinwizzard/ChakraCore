...
namespace Js
{
    class WithScopeObject : public RecyclableObject
    {
        private:
            ...
            int Cauterizing() { AssertMsg(false, "This function is not exposed for this wrapper"); return 0; }
        protected:
        ...
        public:
            ...
            DescriptorFlags GetSetter(JavascriptString* propertyNameString, Var *setterValue, PropertyValueInfo* info, ScriptContext* requestContext) override { Cauterizing(); return None; };
