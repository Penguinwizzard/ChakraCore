...
enum TypeId
{
    ...
    TypeIds_HostDispatch = 16,
    TypeIds_WithScopeObject = 17,
    TypeIds_UndeclBlockVar = 18,
    ...
    TypeIds_NativeIntArray = 23,
    TypeIds_CopyOnAccessNativeIntArray = 24,
    TypeIds_NativeFloatArray = 25,
    TypeIds_ArrayLast = TypeIds_NativeFloatArray,
    TypeIds_Date = 26,
    TypeIds_RegEx = 27,
    TypeIds_Error = 28,
    TypeIds_BooleanObject = 29,
    TypeIds_NumberObject = 30,
    TypeIds_StringObject = 31,
    TypeIds_Arguments = 32,
    TypeIds_ES5Array = 33,
