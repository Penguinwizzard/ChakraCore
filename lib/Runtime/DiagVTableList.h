...
TYPEHANDLER_ENTRY(SimpleTypeHandlerSize3)
...
STRING_ENTRY_TEMPLATE(ConcatStringN6, ConcatStringN, 6)
STRING_ENTRY_TEMPLATE(ConcatStringN7, ConcatStringN, 7)
STRING_ENTRY(ConcatStringBuilder)
STRING_ENTRY_TEMPLATE(ConcatStringWrappingSB, ConcatStringWrapping, L'[', L']')
STRING_ENTRY_TEMPLATE(ConcatStringWrappingB,  ConcatStringWrapping, L'{', L'}')
STRING_ENTRY_TEMPLATE(ConcatStringWrappingQ,  ConcatStringWrapping, L'"', L'"')
