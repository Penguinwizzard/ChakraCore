...
static const RPC_CLIENT_INTERFACE CodeGen___RpcClientInterface =
    {
...
RPC_IF_HANDLE CodeGen_v1_0_c_ifspec = (RPC_IF_HANDLE)& CodeGen___RpcClientInterface;

extern const MIDL_STUB_DESC CodeGen_StubDesc;

static RPC_BINDING_HANDLE CodeGen__MIDL_AutoBindHandle;
    ...
    /* [in] */ handle_t binding)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&CodeGen_StubDesc,
                  (PFORMAT_STRING) &CodeGen__MIDL_ProcFormatString.Format[0],
                  binding);
    ...
    /* [in] */ handle_t binding)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&CodeGen_StubDesc,
                  (PFORMAT_STRING) &CodeGen__MIDL_ProcFormatString.Format[30],
                  binding);
...
static const MIDL_STUB_DESC CodeGen_StubDesc =
    {
    (void *)& CodeGen___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &CodeGen__MIDL_AutoBindHandle,
    0,
    0,
    0,
    0,
