...
template _ALWAYSINLINE BVSparseNode * BVSparse<JitArenaAllocator>::NodeFromIndex(BVIndex i);
template _ALWAYSINLINE BVSparseNode * BVSparse<JitArenaAllocator>::NodeFromIndexWithEditSupport(BVIndex i);
