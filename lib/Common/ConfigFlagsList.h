...
#define DEFAULT_CONFIG_LoopIterationsToBailoutsRatioForRejit 20 // Ratio of loop iteration count to bailouts above which a rejit of the loop body is considered
