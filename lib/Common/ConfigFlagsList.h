...
FLAGNR(Boolean, BytecodeHistAll       , "Provide a histogram of the bytecodes run & encoded by the script for js and asm.js.", false)
FLAGNR(Boolean, BytecodeHist          , "Provide a histogram of the bytecodes run by the script. (NoNative required).", false)
FLAGNR(Boolean, BytecodeHistAsmJs     , "Provide a histogram of the bytecodes run by the script for asm.js. (NoNative required).", false)
FLAGNR(Boolean, BytecodeEncHist       , "Provide a histogram of the bytecodes encoded by the script.", false)
FLAGNR(Boolean, BytecodeEncHistAsmJs  , "Provide a histogram of the bytecodes encoded by the script for asm.js.", false)
