...
WASM_BINARY_OPCODE(I64Add,            0x5b, L_LL, Add_Long       , true)
WASM_BINARY_OPCODE(I64Sub,            0x5c, L_LL, Sub_Long       , true)
WASM_BINARY_OPCODE(I64Mul,            0x5d, L_LL, Mul_Long       , true)
WASM_BINARY_OPCODE(I64DivS,           0x5e, L_LL, Div_Long       , true)
WASM_BINARY_OPCODE(I64DivU,           0x5f, L_LL, Div_ULong      , true)
WASM_BINARY_OPCODE(I64RemS,           0x60, L_LL, Rem_Long       , true)
WASM_BINARY_OPCODE(I64RemU,           0x61, L_LL, Rem_ULong      , true)
WASM_BINARY_OPCODE(I64And,            0x62, L_LL, And_Long       , true)
WASM_BINARY_OPCODE(I64Or,             0x63, L_LL, Or_Long        , true)
WASM_BINARY_OPCODE(I64Xor,            0x64, L_LL, Xor_Long       , true)
WASM_BINARY_OPCODE(I64Shl,            0x65, L_LL, Shl_Long       , true)
WASM_BINARY_OPCODE(I64ShrU,           0x66, L_LL, Shr_ULong      , true)
WASM_BINARY_OPCODE(I64ShrS,           0x67, L_LL, Shr_Long       , true)
WASM_BINARY_OPCODE(I64Eq,             0x68, I_LL, CmEq_Long      , true)
WASM_BINARY_OPCODE(I64Ne,             0x69, I_LL, CmNe_Long      , true)
WASM_BINARY_OPCODE(I64LtS,            0x6a, I_LL, CmLt_Long      , true)
WASM_BINARY_OPCODE(I64LeS,            0x6b, I_LL, CmLe_Long      , true)
WASM_BINARY_OPCODE(I64LtU,            0x6c, I_LL, CmLt_ULong     , true)
WASM_BINARY_OPCODE(I64LeU,            0x6d, I_LL, CmLe_ULong     , true)
WASM_BINARY_OPCODE(I64GtS,            0x6e, I_LL, CmGt_Long      , true)
WASM_BINARY_OPCODE(I64GeS,            0x6f, I_LL, CmGe_Long      , true)
WASM_BINARY_OPCODE(I64GtU,            0x70, I_LL, CmGt_ULong     , true)
WASM_BINARY_OPCODE(I64GeU,            0x71, I_LL, CmGe_ULong     , true)
WASM_UNARY__OPCODE(I64Clz,            0x72, L_L , Clz_Long       , true)
WASM_UNARY__OPCODE(I64Ctz,            0x73, L_L , Ctz_Long       , true)
WASM_UNARY__OPCODE(I64Popcnt,         0x74, L_L , PopCnt_Long    , true)
...
WASM_BINARY_OPCODE(I64Rol,            0xb8, L_LL, Rol_Long       , true)
WASM_BINARY_OPCODE(I64Ror,            0xb9, L_LL, Ror_Long       , true)
WASM_BINARY_OPCODE(I64Eqz,            0xba, I_L , Eqz_Long       , true)
