...
WASM_MISC_OPCODE(I64Const,       0x11,        Limit, false)
...
WASM_MEMREAD_OPCODE(I64LoadMem8S,    0x24,        L_I, false, Js::ArrayBufferView::TYPE_INT8_TO_INT64)
WASM_MEMREAD_OPCODE(I64LoadMem8U,    0x25,        L_I, false, Js::ArrayBufferView::TYPE_UINT8_TO_INT64)
WASM_MEMREAD_OPCODE(I64LoadMem16S,   0x26,        L_I, false, Js::ArrayBufferView::TYPE_INT16_TO_INT64)
WASM_MEMREAD_OPCODE(I64LoadMem16U,   0x27,        L_I, false, Js::ArrayBufferView::TYPE_UINT16_TO_INT64)
WASM_MEMREAD_OPCODE(I64LoadMem32S,   0x28,        L_I, false, Js::ArrayBufferView::TYPE_INT32_TO_INT64)
WASM_MEMREAD_OPCODE(I64LoadMem32U,   0x29,        L_I, false, Js::ArrayBufferView::TYPE_UINT32_TO_INT64)
WASM_MEMREAD_OPCODE(I32LoadMem,      0x2a,        I_I, false, Js::ArrayBufferView::TYPE_INT32)
WASM_MEMREAD_OPCODE(I64LoadMem,      0x2b,        L_I, false, Js::ArrayBufferView::TYPE_INT64)
...
WASM_MEMSTORE_OPCODE(I64StoreMem8,    0x30,        L_IL, false, Js::ArrayBufferView::TYPE_INT8_TO_INT64)
WASM_MEMSTORE_OPCODE(I64StoreMem16,   0x31,        L_IL, false, Js::ArrayBufferView::TYPE_INT16_TO_INT64)
WASM_MEMSTORE_OPCODE(I64StoreMem32,   0x32,        L_IL, false, Js::ArrayBufferView::TYPE_INT32_TO_INT64)
WASM_MEMSTORE_OPCODE(I32StoreMem,     0x33,        I_II, false, Js::ArrayBufferView::TYPE_INT32)
WASM_MEMSTORE_OPCODE(I64StoreMem,     0x34,        L_IL, false, Js::ArrayBufferView::TYPE_INT64)
...
WASM_BINARY_OPCODE(I64Add,            0x5b, L_LL, Add_Long       , false)
WASM_BINARY_OPCODE(I64Sub,            0x5c, L_LL, Sub_Long       , false)
WASM_BINARY_OPCODE(I64Mul,            0x5d, L_LL, Mul_Long       , false)
WASM_BINARY_OPCODE(I64DivS,           0x5e, L_LL, Div_Long       , false)
WASM_BINARY_OPCODE(I64DivU,           0x5f, L_LL, Div_ULong      , false)
WASM_BINARY_OPCODE(I64RemS,           0x60, L_LL, Rem_Long       , false)
WASM_BINARY_OPCODE(I64RemU,           0x61, L_LL, Rem_ULong      , false)
WASM_BINARY_OPCODE(I64And,            0x62, L_LL, And_Long       , false)
WASM_BINARY_OPCODE(I64Or,             0x63, L_LL, Or_Long        , false)
WASM_BINARY_OPCODE(I64Xor,            0x64, L_LL, Xor_Long       , false)
WASM_BINARY_OPCODE(I64Shl,            0x65, L_LL, Shl_Long       , false)
WASM_BINARY_OPCODE(I64ShrU,           0x66, L_LL, Shr_ULong      , false)
WASM_BINARY_OPCODE(I64ShrS,           0x67, L_LL, Shr_Long       , false)
WASM_BINARY_OPCODE(I64Eq,             0x68, I_LL, CmEq_Long      , false)
WASM_BINARY_OPCODE(I64Ne,             0x69, I_LL, CmNe_Long      , false)
WASM_BINARY_OPCODE(I64LtS,            0x6a, I_LL, CmLt_Long      , false)
WASM_BINARY_OPCODE(I64LeS,            0x6b, I_LL, CmLe_Long      , false)
WASM_BINARY_OPCODE(I64LtU,            0x6c, I_LL, CmLt_ULong     , false)
WASM_BINARY_OPCODE(I64LeU,            0x6d, I_LL, CmLe_ULong     , false)
WASM_BINARY_OPCODE(I64GtS,            0x6e, I_LL, CmGt_Long      , false)
WASM_BINARY_OPCODE(I64GeS,            0x6f, I_LL, CmGe_Long      , false)
WASM_BINARY_OPCODE(I64GtU,            0x70, I_LL, CmGt_ULong     , false)
WASM_BINARY_OPCODE(I64GeU,            0x71, I_LL, CmGe_ULong     , false)
WASM_UNARY__OPCODE(I64Clz,            0x72, L_L , Clz_Long       , false)
WASM_UNARY__OPCODE(I64Ctz,            0x73, L_L , Ctz_Long       , false)
WASM_UNARY__OPCODE(I64Popcnt,         0x74, L_L , PopCnt_Long    , false)
...
WASM_UNARY__OPCODE(I32ConvertI64,     0xa1, I_L , Conv_LTI       , true)
WASM_UNARY__OPCODE(I64SConvertF32,    0xa2, L_F , Conv_FTL       , true)
WASM_UNARY__OPCODE(I64SConvertF64,    0xa3, L_D , Conv_DTL       , true)
WASM_UNARY__OPCODE(I64UConvertF32,    0xa4, L_F , Conv_FTUL      , true)
WASM_UNARY__OPCODE(I64UConvertF64,    0xa5, L_D , Conv_DTUL      , true)
WASM_UNARY__OPCODE(I64SConvertI32,    0xa6, L_I , Conv_ITL       , true)
WASM_UNARY__OPCODE(I64UConvertI32,    0xa7, L_I , Conv_UTL       , true)
WASM_UNARY__OPCODE(F32SConvertI32,    0xa8, F_I , Fround_Int     , false)
WASM_UNARY__OPCODE(F32UConvertI32,    0xa9, F_I , Conv_UTF       , true)
WASM_UNARY__OPCODE(F32SConvertI64,    0xaa, F_L , Fround_Long    , true)
WASM_UNARY__OPCODE(F32UConvertI64,    0xab, F_L , Conv_ULTF      , true)
...
WASM_UNARY__OPCODE(F64SConvertI64,    0xb0, D_L , Conv_LTD       , true)
WASM_UNARY__OPCODE(F64UConvertI64,    0xb1, D_L , Conv_ULTD      , true)
WASM_UNARY__OPCODE(F64ConvertF32,     0xb2, D_F , Conv_FTD       , false)
WASM_UNARY__OPCODE(F64ReinterpretI64, 0xb3, D_L , Reinterpret_LTD, true)
...
WASM_BINARY_OPCODE(I64Ror,            0xb8, L_LL, Ror_Long       , false)
WASM_BINARY_OPCODE(I64Rol,            0xb9, L_LL, Rol_Long       , false)
WASM_UNARY__OPCODE(I64Eqz,            0xba, I_L , Eqz_Long       , false)
