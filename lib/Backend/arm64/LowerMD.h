...
public:
    ...
    static  void            ImmedSrcToReg(IR::Instr * instr, IR::Opnd * newOpnd, int srcNum) { __debugbreak(); }
      ...
      static  IR::Instr *     LowerMultiBranch(IR::Instr * instr) { __debugbreak(); return 0; }
       ...
       static void            EmitPtrInstr(IR::Instr *instr) { __debugbreak(); }
              ...
              bool            EmitLoadInt32(IR::Instr *instr, const bool isInHelperBlock, bool conversionFromObjectAllowed) { __debugbreak(); return 0; }
       ...
       static void            LowerInt4RemWithBailOut(IR::Instr *const instr, const IR::BailOutKind bailOutKind, IR::LabelInstr *const bailOutLabel, IR::LabelInstr *const skipBailOutLabel) { __debugbreak(); }
              ...
              IR::RegOpnd *   EmitLoadFloat(IR::Opnd *dst, IR::Opnd *src, IR::Instr *insertInstr, const bool isInHelperBlock) { __debugbreak(); return 0; }
              IR::Instr *     LoadCheckedFloat(IR::RegOpnd *opndOrig, IR::RegOpnd *opndFloat, IR::LabelInstr *labelInline, IR::LabelInstr *labelHelper, IR::Instr *instrInsert, const bool isInHelperBlock, const bool checkForNullInLoopBody = false) { __debugbreak(); return 0; }
  ...
  public:
       ...
       static IR::BranchInstr *   LowerFloatCondBranch(IR::BranchInstr *instrBranch, bool ignoreNaN = false) { __debugbreak(); return 0; }
              ...
              IR::LabelInstr*     EmitLoadFloatCommon(IR::Opnd *dst, IR::Opnd *src, IR::Instr *insertInstr, bool needHelperLabel, const bool isInHelperBlock) { __debugbreak(); return 0; }
