...
BAIL_OUT_KIND(BailOutOnImplicitCallsPreOp,          (IR::BailOutOnResultConditions | IR::BailOutForArrayBits | IR::BailOutOnMiscellaneousConditions) & ~IR::BailOutOnArrayAccessHelperCall )
...
BAIL_OUT_KIND(BailOutFailedTypeCheck,               IR::BailOutOnMiscellaneousConditions)
BAIL_OUT_KIND(BailOutFailedEquivalentTypeCheck,     IR::BailOutOnMiscellaneousConditions)
...
BAIL_OUT_KIND(BailOutFailedFixedFieldTypeCheck,     IR::BailOutOnMiscellaneousConditions)
BAIL_OUT_KIND(BailOutFailedFixedFieldCheck,         0)
BAIL_OUT_KIND(BailOutFailedEquivalentFixedFieldTypeCheck, IR::BailOutOnMiscellaneousConditions)
