...
LowererMD::LoadHeapArguments(IR::Instr * instrArgs, bool force /* = false */, IR::Opnd *opndInputParamCount /* = nullptr */)
{
    ...
    else
    {
        ...
        if (func->IsInlinee())
        {
            ...
            if (!this->m_func->GetHasStackArgs() || force)
            {
                // s1 = current function.
        ...
        {
            this->ChangeToHelperCall(instrArgs, IR::HelperOp_FillFrameObject);
        }
    }
    return instrPrev;
}
...
LowererMD::LoadHeapArgsCached(IR::Instr * instrArgs)
{
    ...
    {
        this->ChangeToHelperCall(instrArgs, IR::HelperOp_FillFrameObjectCached);
    }
    return instrPrev;
}
