...
private:
    ...
    void                    CreateLoadConstInstrForType(Js::Var table, Js::RegSlot& regAllocated, uint32 reservedCount, uint32 constCount, uint32 offset, IRType irType, ValueType valueType, Js::OpCode opcode, F extraProcess);
