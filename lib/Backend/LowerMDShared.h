...
public:
    ...
    void                Simd128LoadHeadSegment(IR::IndirOpnd *indirOpnd, IR::Instr *instr);
    void                Simd128GenerateUpperBoundCheck(IR::RegOpnd *indexOpnd, IR::IndirOpnd *indirOpnd, IR::Instr *instr);
