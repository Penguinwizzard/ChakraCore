...
public:
    ...
    virtual Js::Var GetCurrentIndex() override;
    virtual Js::Var GetCurrentValue() override;
    virtual BOOL MoveNext(Js::PropertyAttributes* attributes = nullptr) override;
    virtual void Reset() override;
    virtual Js::Var GetCurrentAndMoveNext(Js::PropertyId& propertyId, Js::PropertyAttributes* attributes = nullptr) override;
    virtual Js::Var GetCurrentBothAndMoveNext(Js::PropertyId& propertyId, Js::Var* currentValueRef) override;
protected:
...
private:
    ...
    Js::PropertyId GetPropertyIdOfIndex(Js::Var  index);
};
