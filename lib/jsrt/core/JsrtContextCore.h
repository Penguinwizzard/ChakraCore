...
public:
    ...
    DWORD FetchImportedModule(Js::ModuleRecordBase* referencingModule, Js::JavascriptString* specifier, Js::ModuleRecordBase** dependentModuleRecord) override
    {
        AssertMsg(false, "not implemented");
        return S_FALSE;
    }

    DWORD NotifyModuleReady(Js::ModuleRecordBase* referencingModule, Js::Var exceptionVar) override
    {
        AssertMsg(false, "not implemented");
        return S_FALSE;
    }
