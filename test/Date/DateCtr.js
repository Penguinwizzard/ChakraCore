...
//d = new Date(); write(d.toISOString());
...
d = new Date(); d.setSeconds(-Number.MAX_VALUE); write(d); // WOOB 1142298
/*
d = Date(); write(d.toISOString());
d = Date("Thu Jan 10 05:30:01 UTC+0530 1970"); write(d.toISOString());
d = Date("1974"); write(d.toISOString());
d = Date(1974); write(d.toISOString());
d = Date(1974, 9); write(d.toISOString());
d = Date(1974, 9, 24); write(d.toISOString());
d = Date(1974, 9, 24, 0); write(d.toISOString());
d = Date(1974, 9, 24, 0, 20); write(d.toISOString());
d = Date(1974, 9, 24, 0, 20, 30); write(d.toISOString());
d = Date(1974, 9, 24, 0, 20, 30, 40); write(d.toISOString());
d = Date(1974, 9, 24, 0, 20, 30, 40, 50); write(d.toISOString());
*/