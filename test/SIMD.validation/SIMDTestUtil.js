...
var bool32x4 = {
  ...
  fn: SIMD.Bool32x4,
  boolLane: true,
  logical: true,//arun::ToDo differs from polyfill but match the spec.raising an issue
  lanes: 4,
  laneSize: 4,
...
function testOperators(type) {
  ...
  //equal('function', typeof inst.toLocaleString); //TODO enable toLocaleString for all types. 
...
simdTypes.filter(hasLoadStore123).forEach(function(type) {
  ...
  test(type.name + ' store2', function() {
