...
var d = false;
var z;
var lib = SIMD.Float32x4;

z = func1(true, lib);
equalSimd([0, 100, 101, 1], z, lib, "func1-true");
z = func1(false, lib);
equalSimd([0, 98, 101, 98], z, lib, "func1-true");
z = func1(true, lib);
equalSimd([0, 100, 101, 1], z, lib, "func1-true");
z = func1(false, lib);
equalSimd([0, 98, 101, 98], z, lib, "func1-true");
...
lib = SIMD.Int32x4;
z = func1(true, lib);
equalSimd([5, 104, 101, 2], z, lib, "func1-true");
z = func1(false, lib);
equalSimd([104, 102, 101, 2], z, lib, "func1-true");
z = func1(true, lib);
equalSimd([5, 104, 101, 2], z, lib, "func1-true");
z = func1(false, lib);
equalSimd([104, 102, 101, 2], z, lib, "func1-true");
