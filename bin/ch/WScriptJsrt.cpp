...
bool WScriptJsrt::Initialize()
{
    ...
    IfFalseGo(WScriptJsrt::InstallObjectsOnObject(global, _u("read"), LoadTextFileCallback));
    IfFalseGo(WScriptJsrt::InstallObjectsOnObject(global, _u("readbuffer"), LoadBinaryFileCallback));
