...
struct JsAPIHooks
{
    ...
    typedef JsErrorCode(WINAPI *JsrtRunWasmScriptPtr)(const wchar_t *script, DWORD_PTR sourceContext, const wchar_t *sourceUrl, JsValueRef* result);
...
#ifdef ENABLE_WASM
    static JsErrorCode WINAPI JsRunWasmScript(const wchar_t *script, DWORD_PTR sourceContext, const wchar_t *sourceUrl, bool isBinary, JsValueRef* result) { return m_jsApiHooks.pfJsrtRunWasmScript(script, sourceContext, sourceUrl, result); }
#endif
